...
function CivilContracting() {
    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div data-aos="fade-up" className="font-[Montserrat] font-semibold text-[#fe3032] text-xl sm:text-2xl md:text-3xl my-5">Electrical Contracting</div>
            <div className="flex items-center justify-center flex-col xl:flex-row gap-5 py-10">
                ...
                <div className="flex items-start justify-center flex-wrap gap-5 sm:px-10 lg:w-[43rem]">
                    <div data-aos="fade-left" className="w-60 lg:w-72 bg-slate-100 hover:border-none hover:bg-[#ffa55b] group hover:text-[#014783] px-3 py-1 h-36 lg:h-44 rounded-2xl transition-all duration-300">
